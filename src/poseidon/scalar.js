...
import * as Scalar_bigint from 'poseidon/scalar_bigint.js'
import * as Scalar_native from 'poseidon/scalar_native.js'
...
Scalar.toRprLE = function rprBE(buff, o, e, n8) {
  ...
  for (let i = v.length * 4; i < n8; i++)
    buff[i] = Scalar.toNumber(Scalar.band(Scalar.shiftRight(e, i * 8), 0xff))
}
