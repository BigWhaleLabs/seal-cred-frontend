...
export default function () {
  return (
    ...
    >
      ...
      />
      <circle className={strokeEye} cx="57.9965" cy="30.9215" r="4.1996" />
      <circle className={fillPrimary} cx="24.113" cy="35.7217" r="2.10133" />
      <path
        className={mainStroke}
      ...
      />
      <path className={mainStroke} d="M58 20.095L58 16.1953" />
      <line
        className={mainStroke}
        x1="58.1953"
        x2="58.1953"
