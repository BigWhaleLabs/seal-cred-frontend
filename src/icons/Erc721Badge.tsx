  ...
  return Math.random() > 0.5 ? (
    ...
    >
      ...
      <path
        ...
        stroke-linecap="round"
      />
      <path d="M48 37L42 38" className={pathClasses} stroke-linecap="round" />
      <path d="M42 41L48 42" className={pathClasses} stroke-linecap="round" />
      <path d="M16 37L22 38" className={pathClasses} stroke-linecap="round" />
      <path d="M22 41L16 42" className={pathClasses} stroke-linecap="round" />
    </svg>
  )
}
