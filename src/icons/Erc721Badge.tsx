...
export default function () {
  ...
  return random ? (
    ...
    >
      ...
      />
      <path className={pathClasses} d="M48 37L42 38" />
      <path className={pathClasses} d="M42 41L48 42" />
      <path className={pathClasses} d="M16 37L22 38" />
      <path className={pathClasses} d="M22 41L16 42" />
    </svg>
  )
}
