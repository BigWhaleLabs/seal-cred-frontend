  ...
  return (
    <div style={{ width: '12.625rem' }}>
      <svg
        ...
        viewBox="0 0 202 700"
      >
        <line x1="10" y1="80" x2="10" y2="240" className={strokeTertiary} />
        <line x1="192" y1="80" x2="192" y2="250" className={strokeSecondary} />
        <line x1="102" x2="102" y1="0" y2="210" className={strokeAccent} />
      </svg>
    </div>
  )
}
