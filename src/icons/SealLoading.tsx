...
export default function ({ color }: { color: Color }) {
  ...
  return (
    ...
    >
      <circle className={circleStyles} cx="101" cy="101" r="66" />
      <path
      ...
      />
      <path className={strokeStyles} d="M135.064 111.645L122.29 113.774" />
      <path className={strokeStyles} d="M122.29 120.161L135.064 122.29" />
      <path className={strokeStyles} d="M66.9348 111.645L79.709 113.774" />
      <path className={strokeStyles} d="M79.7088 120.161L66.9346 122.29" />
      <path
        className={strokeStyles}
