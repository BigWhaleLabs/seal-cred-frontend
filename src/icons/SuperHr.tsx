...
export default function () {
  return (
    <div className={svgBox}>
      ...
      >
        <circle cx="99.5" cy="33.5" r="32.5" className={circleClasses} />
        <path
        ...
        <path
          ...
          className={strokeColor}
        />
        <circle cx="99.5" cy="7.09375" r="1.01562" className={fillColor} />
        <circle cx="81.2188" cy="14.2031" r="1.01562" className={fillColor} />
        <circle cx="79.1875" cy="33.5" r="1.01562" className={fillColor} />
        <circle cx="113.719" cy="19.2812" r="1.01562" className={fillColor} />
        <circle cx="119.812" cy="33.5" r="1.01562" className={fillColor} />
        <circle cx="85.2812" cy="47.7188" r="1.01562" className={fillColor} />
        <circle cx="99.5" cy="59.9062" r="1.01562" className={fillColor} />
        <circle cx="118.797" cy="51.7812" r="1.01562" className={fillColor} />
        <line
          x1="67.5"
          y1="34.0156"
          x2="72.5938"
          ...
          className={strokeColor}
        />
        <circle cx="81.2188" cy="42.6406" r="1.01562" className={fillColor} />
        <circle cx="117.781" cy="25.375" r="1.01562" className={fillColor} />
        <line
          x1="71.2861"
          y1="47.5557"
          x2="81.5636"
        ...
        <line
          ...
          className={strokeColor}
        />
        <line x1="59.5" y1="40.5" x2="0.5" y2="40.5" className={strokeColor} />
        <line
          x1="198.5"
          y1="40.5"
          x2="139.5"
          ...
          className={strokeColor}
        />
        <line x1="59.5" y1="28.5" x2="0.5" y2="28.5" className={strokeColor} />
        <line
          x1="198.5"
          y1="28.5"
          x2="139.5"
        ...
        <g filter="url(#filter0_d_90_6555)">
          <circle cx="99.5" cy="33.5" r="12.5" className={fillColor} />
        </g>
        <defs>
          <filter
